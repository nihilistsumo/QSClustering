...
def vital_wiki_clustering_single_model_with_sections(vital_wiki_2cv_data_file,
                                    device,
...
def main():
    ...
    if args.experiment == 1:
        vital_wiki_clustering_single_model(args.vital_data, args.nq, device, args.loss, args.query_con, args.max_num_tokens,
                                           args.max_grad_norm, args.weight_decay, args.warmup, args.lrate, args.epochs,
                                           args.model_name, args.emb_dim, args.output_path)
    elif args.experiment == 2:
        vital_wiki_clustering_single_model_with_sections(args.vital_data, device, args.loss, args.query_con,
                                                         args.max_num_tokens, args.max_grad_norm, args.weight_decay,
                                                         args.warmup, args.lrate, args.epochs, args.model_name,
                                                         args.emb_dim, args.output_path)
