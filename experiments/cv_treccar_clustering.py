...
parser.add_argument('-ne', '--experiment', type=int, help='Choose the experiment to run (1: QSC/ 2: DKM param/ 3: baseline)', default=1)
parser.add_argument('-ls', '--loss', help='Loss func to use for QSC', default='adj')

args = parser.parse_args()
if args.experiment == 1:
    treccar_clustering_single_model(args.vital_data, device, args.loss)
